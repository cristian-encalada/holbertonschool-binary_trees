...
```
### __Print function__
To match the examples in the tasks, you are given thE function `binary_tree_print.c` in this [repository](https://github.com/hs-hq/0x1C.c)
```
                           .----------------------(006)-------.
                      .--(001)-------.                   .--(008)--.
                 .--(-02)       .--(003)-------.       (007)     (009)
...
* __Cristian Encalada__ - *Holberton Student* - [Cristian Encalada](https://github.com/cristian-encalada/)
* __Fabiana Tellechea__ - *Holberton Student* - [Fabiana Tellechea](https://github.com/fabianatellechea/)